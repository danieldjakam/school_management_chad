        ...
        <nav className="navbar navbar-expand-lg" style={{padding: '10px'}}>
            <div className="collapse navbar-collapse" id="navbarNav">
                <ul className="navbar-nav" style={{fontSize: '1.3rem', display:"flex", justifyContent:'space-between'}}>
                    ...
                    <a href={host+"/download/pdf/bul-an/"+class_id+'/'+exam_id} target={'_blank'} className="btn btn-success">{sequenceTraductions['fr'].downloadBuls}</a>
                    ...
                    students.length > 0 ? students.map((student, index) => {
                        ...
                        return <tr key={index}>
                            ...
                            <td>
                                ...
                                <a target={'_blank'} href={`${host}/download/pdf/bul-an/${class_id}/${student.id}/${exam_id}`} 
