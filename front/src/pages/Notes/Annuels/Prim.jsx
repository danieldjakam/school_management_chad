        ...
        <nav className="navbar navbar-expand-lg" style={{padding: '10px'}}>
            <div className="collapse navbar-collapse" id="navbarNav">
                <ul className="navbar-nav" style={{fontSize: '1.3rem', display:"flex", justifyContent:'space-between'}}>
                    ...
                    <a href={host+`/download/pdf/bul-an2/${ActualClass.year}/`+class_id+'/'+exam_id} target={'_blank'} className="btn btn-success">{sequenceTraductions['fr'].downloadBuls}</a>
                    ...
                    return <tr key={index}>
                        ...
                        <td>
                            <Link to={`${student.id}`} className="btn btn-primary">
                                ...
                                <a target={'_blank'} href={`${host}/download/pdf/bul-an2/${ActualClass.year}/${class_id}/${student.id}/${exam_id}`} 
